library(ggplot2)
library(ggmap, lib.loc="/dss/dsshome1/lxc0E/di67kah/R")
library(maps)
library(mapdata)
library(sf)
library(rnaturalearth, lib.loc="/dss/dsshome1/lxc0E/di67kah/R")
library(rnaturalearthdata, lib.loc="/dss/dsshome1/lxc0E/di67kah/R")
library(rnaturalearthhires, lib.loc="/dss/dsshome1/lxc0E/di67kah/R")
library(ggspatial, lib.loc="/dss/dsshome1/lxc0E/di67kah/R")
library(dplyr)
library(ggshadow, lib.loc="/dss/dsshome1/lxc0E/di67kah/R")
library(ggbreak, lib.loc="/dss/dsshome1/lxc0E/di67kah/R")
...
f2 <- ggplot() + 
  ...
  geom_point(data=loc, aes(x=longitude, y=latitude, fill=country, shape=period, alpha=period, size=period, color=period,stroke = 1)) +
  geom_point(data=loc%>%filter(period %in% c("100-1500")), aes(x=longitude, y=latitude, fill=country, shape=period, alpha=period, size=period, color=period)) +
  geom_point(data=loc%>%filter(period=="1500-3000"| period=="more_than_10k"), aes(x=longitude, y=latitude, fill=country, shape=period, alpha=period, size=period, color=period)) +
  geom_point(data=loc%>%filter(period=="5000-6000" | period=="more_than_20k"), aes(x=longitude, y=latitude, fill=country, shape=period, alpha=period, size=period, color=period)) +
  scale_shape_manual(values = c("100-1500" = 21, "1500-3000" = 22, "5000-6000"=23,"more_than_10k"=24,"more_than_20k"=25,"present"=21)) +
  scale_size_manual(values = c("100-1500" = 3, "1500-3000" = 3, "5000-6000"=3,"more_than_10k"=3,"more_than_20k"=3,"present"=2)) +
...
# Age Plot-----------------------------------------------------------------------------------------------------------------------------------------------
f1 <- ggplot() +
  geom_point(data=loc, aes(x=longitude, y=age, fill=country, shape=period, alpha=period, size=period, color=period)) +
  geom_point(data=loc%>%filter(period %in% c("100-1500","undated_100","undated_2k","undated_5k")), aes(x=longitude, y=age, fill=country, shape=period, alpha=period, size=period, color=period)) +
  geom_point(data=loc%>%filter(period %in% c("1500-3000","5000-6000","more_than_10k","more_than_20k")), aes(x=longitude, y=age, fill=country, shape=period, alpha=period, size=period, color=period)) +
  scale_shape_manual(values = c("100-1500" = 21, "1500-3000" = 22, "5000-6000"=23,"more_than_10k"=24,"more_than_20k"=25,"present"=21,"undated_100"=21,"undated_2k"=22,"undated_5k"=23)) +
  scale_size_manual(values = c("100-1500" = 3, "1500-3000" = 3, "5000-6000"=3,"more_than_10k"=3,"more_than_20k"=3,"present"=2,"undated_100"=2,"undated_2k"=2,"undated_5k"=2)) +
  ...
  scale_color_manual(values = c("100-1500" = "black", "1500-3000" = "black", "5000-6000"="black","more_than_10k"="black","more_than_20k"="black","present"="white","undated_100"="black","undated_2k"="black","undated_5k"="black")) +
  scale_y_break(c(7000, 15000)) +
...
proj1 <- ggplot() +
  ...
  geom_point(data=df1%>%filter(period=="5000-6000" | period=="more_than_20k"), aes(x=PC1, y=PC2, fill=country, shape=period, alpha=period, size=period, color=period)) +
  geom_point(data=df1%>%filter(country == "NL" | sample == "LSS003_TE" | sample == "HOC005_TE"), aes(x=PC1, y=PC2, fill=country, shape=period, alpha=period, size=period, color=period))  +
  scale_shape_manual(values = c("100-1500" = 21, "1500-3000" = 22, "5000-6000"=23,"more_than_10k"=24,"more_than_20k"=25,"present"=21)) +
  scale_size_manual(values = c("100-1500" = 3, "1500-3000" = 3, "5000-6000"=3,"more_than_10k"=3,"more_than_20k"=3,"present"=2)) +
  scale_alpha_manual(values = c("100-1500" = 1, "1500-3000" = 1, "5000-6000"=1,"more_than_10k"=1,"more_than_20k"=1,"present"=1)) +
  scale_color_manual(values = c("100-1500" = "black", "1500-3000" = "black", "5000-6000"="black","more_than_10k"="black","more_than_20k"="black","present"="white")) +
...
proj2 <- ggplot() +
  ...
  geom_point(data=df2%>%filter(period=="5000-6000" | period=="more_than_20k"), aes(x=PC1, y=PC2, fill=country, shape=period, alpha=period, size=period, color=period)) +
  geom_point(data=df2%>%filter(country == "NL" | sample == "LSS003_TE" | sample == "HOC005_TE" ), aes(x=PC1, y=PC2, fill=country, shape=period, alpha=period, size=period, color=period))  +
  scale_shape_manual(values = c("100-1500" = 21, "1500-3000" = 22, "5000-6000"=23,"more_than_10k"=24,"more_than_20k"=25,"present"=21)) +
  scale_size_manual(values = c("100-1500" = 3, "1500-3000" = 3, "5000-6000"=3,"more_than_10k"=3,"more_than_20k"=3,"present"=2)) +
  scale_alpha_manual(values = c("100-1500" = 1, "1500-3000" = 1, "5000-6000"=1,"more_than_10k"=1,"more_than_20k"=1,"present"=1)) +
  scale_color_manual(values = c("100-1500" = "black", "1500-3000" = "black", "5000-6000"="black","more_than_10k"="black","more_than_20k"="black","present"="white")) +
  ...
  theme(axis.line = element_line(colour = "black"), panel.grid.major = element_blank(),panel.grid.minor = element_blank(),
        panel.border = element_blank(),panel.background = element_blank(),
        axis.title.x = element_text(size=10,margin = margin(t =0)),axis.title.y = element_text(size=10,margin = margin(t =0)),
...
fig1 <- r1 / r2 / r3  + 
  plot_layout(heights = c(0.8, 2.1, 2)) +
